...
public:
	...
	void execute(XMMATRIX* world, XMMATRIX* view, XMMATRIX* projection, XMFLOAT4 AmbC, XMVECTOR DirV, XMFLOAT4 DirC, XMVECTOR PLightV, XMFLOAT4 PLightC, XMVECTOR SpotV, XMFLOAT4 SpotC, XMVECTOR SpotD);
